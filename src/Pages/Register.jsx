...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      toast.success("Successfully Registered!", { style: { color: "green" } });
  ...
  return (
    <div>
      ...
      <div className="relative w-full">
        <div className="flex flex-col items-center justify-center z-20 px-4 py-6">
          <div className="mx-auto py-6">
            <div className="max-w-6xl mx-auto py-10 p-0">
              {/* Grid */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div
                  ...
                  data-aos-delay="100"
                  className="register-left relative bg-[url(https://i.postimg.cc/Wz1jsqHC/regiser-page.webp)] bg-cover bg-center h-full rounded-xl"
                >
                  <div className="absolute inset-0 h-full bg-sky-700/30 backdrop-blur-[2px] rounded-xl"></div>
                  <div className="relative p-8">
                    <p className="inline-block text-md font-medium bg-clip-text bg-linear-to-l from-rose-600 to-gray-100 text-transparent">
                      Evently: Your Gateway to Local Events
                    </p>

                    {/* Title */}
                    <div className="mt-4 md:mb-12 max-w-2xl pb-8">
                      <h1 className="mb-4 font-bold text-gray-100 text-4xl lg:text-6xl">
                        Find local events, fast and easy
                      </h1>
                      <p className="text-gray-100">
                        Join Evently and explore nearby concerts, meetups, and
                    ...
                    <blockquote className="hidden md:block relative max-w-sm">
                      <svg
                        className="absolute top-0 start-0 transform -translate-x-4 -translate-y-4 size-8 text-gray-200"
                        width="14"
                        height="14"
                        viewBox="0 0 18 18"
                        fill="none"
                      ...
                      <div className="relative z-10">
                        <p className="text-lg italic text-gray-100">
                          Evently makes it so easy to find events I care
                          about. It's like having a local guide in my pocket!
                        </p>
                      </div>
                        ...
                        <div className="flex items-center gap-x-4">
                          <div className="shrink-0">
                            <img
                              ...
                              src="https://i.postimg.cc/zX27rLyR/Jhankar-sir.webp"
                              alt="Avatar"
                            />
                          </div>
                          <div className="grow">
                        ...
                        <div className="grid gap-y-4">
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  id="fname"
                                  name="firstName"
                                  className="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:outline-none focus:border-rose-500 focus:ring-rose-500"
                                  required
                                />
                                {nameError && (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <div className="relative flex items-center border border-gray-200 rounded-lg sm:text-sm focus-within:border-blue-500 focus-within:ring-blue-500">
                                <input
                          ...
                          <div className="flex items-center">
                            <div className="flex">
                              <input
                                ...
                                name="remember-me"
                                type="checkbox"
                                className="shrink-0 mt-0.5 border-rose-200 rounded-sm text-blue-600 focus:ring-rose-500"
                              />
                            </div>
                            <div className="ms-3">
              ...
              <div className="mt-6 md:mt-12 py-3 flex items-center text-sm text-gray-800 gap-x-1.5 after:flex-1 after:border-t after:border-gray-200 after:ms-6">
                <span className="font-semibold bg-clip-text bg-linear-to-l from-blue-600 to-violet-500 text-transparent">
                  1,000
                </span>
                individuals and companies trust Evently
              </div>

              {/* Clients */}
              <div className="flex flex-wrap justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
                <svg
                  className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-gray-600"
